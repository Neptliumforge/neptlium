...
export const dashboardNavItems: readonly RoleAwareNavItem[] = [
  { label: 'Home', href: '/dashboard', minRole: 'user', group: 'Overview', icon: <LayoutDashboard className="size-4" /> },
...
export const dashboardSecondaryNavItems: readonly RoleAwareNavItem[] = [
  { label: 'Help & Support', href: '/dashboard/support', minRole: 'user', group: 'Account', icon: <LifeBuoy className="size-4" /> },
...
export const dashboardMobileSecondaryNavItems: readonly RoleAwareNavItem[] = [
  ...
  { label: 'Help & Support', href: '/dashboard/support', minRole: 'user', icon: <LifeBuoy className="size-4" /> },
