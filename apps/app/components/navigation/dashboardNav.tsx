...
export const dashboardNavItems: readonly RoleAwareNavItem[] = [
  { label: 'Overview', href: '/dashboard', minRole: 'user', group: 'Home', icon: <LayoutDashboard className="size-4" /> },
  ...
  { label: 'Portfolio', href: '/dashboard/portfolio', minRole: 'user', group: 'Intelligence', icon: <Briefcase className="size-4" /> },
  { label: 'Companies', href: '/dashboard/company-intelligence', minRole: 'user', group: 'Intelligence', icon: <Building2 className="size-4" /> },
  { label: 'Allocation', href: '/dashboard/allocations', minRole: 'user', group: 'Decisions', icon: <SlidersHorizontal className="size-4" /> },
];
...
export const dashboardMobilePrimaryNavItems: readonly RoleAwareNavItem[] = [
  ...
  { label: 'Capital', href: '/dashboard/capital-account', minRole: 'user', icon: <Wallet className="size-4" /> },
...
export const dashboardMobileSecondaryNavItems: readonly RoleAwareNavItem[] = [
  { label: 'Companies', href: '/dashboard/company-intelligence', minRole: 'user', icon: <Building2 className="size-4" /> },
