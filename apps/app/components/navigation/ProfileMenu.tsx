    ...
    <div className="relative">
      ...
      {open && (
        ...
        >
          ...
          <Link
            href="/dashboard/treasury-upgrade"
            onClick={() => setOpen(false)}
            className="my-2 flex min-h-16 items-center justify-between rounded-lg border border-border-default bg-surface-2 px-3 py-2 text-sm text-text-primary hover:border-accent-primary"
          >
            <span>
              <strong className="block">Upgrade to Treasury</strong>
              <small className="text-text-muted">
                Business finance, team controls and payments
              </small>
            </span>
