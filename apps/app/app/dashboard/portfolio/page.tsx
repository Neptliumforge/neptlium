  ...
  return (
    <div className="space-y-5">
      ...
      <div className="grid gap-3 md:grid-cols-2">
        <StatCard label="Portfolio valuation" value="—" delta="Connected data required" />
        <StatCard label="Holdings" value="Unavailable" />
      </div>
      <Card>
        <CardContent>
          <EmptyState
            ...
            description="Connected portfolio and custody data are required before holdings or estimated reporting valuations can be shown."
          />
        </CardContent>
      </Card>
    </div>
