...
export const viewport: Viewport = { colorScheme: 'light', themeColor: '#101214', width: 'device-width', initialScale: 1 };
...
export default function RootLayout({ children }: { children: React.ReactNode }) {
  return <html lang="en" data-theme="light"><body><script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify(jsonLd) }} /><SkipLink /><SiteHeader /><main id="main-content">{children}</main><GlobalConversionCta /><SiteFooter /></body></html>;
}
