...
export default function PlatformPage() {
  return <div className={styles.page}>
    ...
    <section className={styles.section} data-npt-surface="cloud" aria-labelledby="map-title"><div className={styles.shell}><div className={styles.sectionHead}><p className={styles.eyebrow}>Product family</p><div><h2 id="map-title">Personal and Business above one shared core.</h2><p>The customer experience changes with the job to be done. The underlying expectations around identity, authority, evidence, reconciliation and audit do not.</p></div></div><div data-npt-product-canvas="dark"><div className={styles.platformMap}><section><p className={styles.eyebrow}>Personal</p><h3>Neptlium Capital</h3><ul><li>Capital</li><li>Portfolio</li><li>Allocation</li><li>Investments</li><li>Activity + documents</li></ul></section><section><p className={styles.eyebrow}>Business</p><h3>Neptlium Treasury</h3><ul><li>Treasury</li><li>Payments</li><li>Approvals</li><li>Policies + risk</li><li>Audit</li></ul></section><div className={styles.platformCore}><h3>Shared Neptlium core</h3><SharedCoreVisual compact /></div></div></div></div></section>
