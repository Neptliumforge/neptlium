      ...
      <aside className="platform-window-sidebar" aria-label="Platform preview navigation">
        ...
        <nav aria-label="Neptlium platform preview navigation">
          {nav.map(([label, Icon], index) => (
            <div
              className={`platform-window-nav-item ${index === 0 ? 'is-active' : ''}`}
      ...
      <div className="platform-window-canvas">
        ...
        <div className="platform-window-content">
          <div className="platform-window-heading">
            <span>Overview</span>
            <h3 id="platform-preview-title">Capital position</h3>
          ...
          <section className="platform-window-account" aria-labelledby="preview-capital-account">
            <div className="platform-window-section-head">
              <div>
                <span id="preview-capital-account">Capital Account</span>
            ...
            <div className="platform-window-assets">
              {assets.map(([asset, network]) => (
                <div key={asset}>
                  <AssetIdentity asset={asset} network={network} size="sm" detailed />
                </div>
              ))}
            </div>
          </section>
          ...
          <div className="platform-window-lower-grid">
            <section aria-labelledby="preview-allocation">
              <span id="preview-allocation">Allocation</span>
            ...
            <section aria-labelledby="preview-treasury">
              <span id="preview-treasury">Treasury</span>
              <h4>Liquidity position</h4>
              <div className="platform-window-mini-metrics">
                <div>
                  <small>Available</small>
                  <strong aria-label="Available unavailable">—</strong>
                </div>
                <div>
                  <small>Reserve</small>
                  <strong aria-label="Reserve unavailable">—</strong>
                </div>
              </div>
            </section>
          </div>
          ...
          <section className="platform-window-activity" aria-labelledby="preview-activity">
            <div className="platform-window-section-head">
              <div>
                <span id="preview-activity">Capital Activity</span>
