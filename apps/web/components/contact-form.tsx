 ...
 * Online submissions are intentionally disabled, so the form does NOT submit
 * or imply a success state. Attempting to submit surfaces a
      ...
      >
        {notice && (
          <div className="flex items-start gap-2 rounded-lg border border-warning/30 bg-surface-subtle p-3 text-sm text-text">
            ...
            <span>
              Online message submission is not currently offered. Please email us directly at{' '}
              <a
